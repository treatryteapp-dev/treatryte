...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "TreatRyte" },
      { property: "og:site_name", content: "TreatRyte" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "TreatRyte — Your health, on time. In one place." },
      { name: "twitter:title", content: "TreatRyte — Your health, on time. In one place." },
      { name: "description", content: "TreatRyte is a sleek, modern landing page for a health and finance app." },
      { property: "og:description", content: "TreatRyte is a sleek, modern landing page for a health and finance app." },
